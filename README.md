...
Proyecto de una calculadora que suma, resta, multiplica y divide.
                      ...
                      Emilio Alonso Mora Rojas 201281283-Fundamentos de computadores
...
msg5 db  0dh,0ah ,'thank you for using the calculator! press any key or esc... ', 0Dh,0Ah, '$'
...
cmp opr, '*'
jb wrong_opr   ;* and / not operate for scan_num
cmp opr, '/'
ja wrong_opr
...
; funtions : plus, minus, mult and div
do_plus:
